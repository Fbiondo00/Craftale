...
export const mockBlogPosts: BlogPost[] = [
  // Case Studies
  {
    ...
    description: 'How we transformed a struggling electronics retailer into a $2M+ online powerhouse with a complete website redesign and conversion optimization.',
    ...
    seo: {
      ...
      metaDescription: 'Discover how we helped TechStore Pro achieve 300% sales increase through strategic web design and conversion optimization.',
  ...
  },
  {
    ...
    description: 'From zero online presence to 150% increase in bookings. See how our restaurant website design transformed this local eatery.',
    content: 'Complete case study content here...',
    ...
    seo: {
      ...
      metaDescription: 'Learn how our restaurant web design increased Bella Vista\'s bookings by 150% with modern design and local SEO.',
  ...
  },
  {
    ...
    description: 'How we engineered a high-converting SaaS landing page that increased signups by 400% for this cloud storage startup.',
    content: 'Complete case study content here...',
    ...
    seo: {
      ...
      metaDescription: 'See how our SaaS landing page design increased CloudSync signups by 400% with strategic UX and conversion optimization.',
  ...
  // Portfolio Projects
  {
    ...
    description: 'A complete digital transformation for a healthcare provider with patient portal integration and appointment booking.',
    ...
    seo: {
      ...
      metaDescription: 'Modern healthcare website design with patient portal integration and full accessibility compliance.',
  ...
  },
  {
    ...
    description: 'Secure and user-friendly banking platform design with advanced financial dashboard and mobile-first approach.',
    content: 'Complete portfolio content here...',
  ...
  // Resource Articles
  {
    ...
    description: 'Stay ahead of the curve with the latest web design trends that are shaping the digital landscape in 2024.',
    ...
    seo: {
      ...
      metaDescription: 'Discover the hottest web design trends for 2024 and how to implement them in your next project.',
  ...
  },
  {
    ...
    description: 'Master the art of website speed optimization with our comprehensive guide covering Core Web Vitals, image optimization, and more.',
    content: 'Complete resource content here...',
  ...
  // Process Documentation
  {
    ...
    description: 'Take a behind-the-scenes look at how we transform ideas into high-performing websites through our proven methodology.',
    ...
    seo: {
      ...
      metaDescription: 'Discover our proven web development methodology that delivers exceptional results for every project.',
  ...
  // Client Spotlights
  {
    ...
    description: 'Meet Sarah Johnson, founder of EduTech Academy, and learn how our partnership transformed her online education platform.',
    ...
    seo: {
      ...
      metaDescription: 'Success story of EduTech Academy and how our web design transformed their online education platform.',
...
export const filterCategories: FilterCategory[] = [
  {
    ...
    label: 'Industry',
    options: [
      { value: 'e-commerce', label: 'E-commerce', count: 12, color: 'bg-color-state-info-subtle text-color-state-info-text' },
      { value: 'saas', label: 'SaaS', count: 8, color: 'bg-brand-tertiary/20 text-brand-tertiary' },
      { value: 'healthcare', label: 'Healthcare', count: 6, color: 'bg-color-state-success-subtle text-color-state-success-text' },
      { value: 'finance', label: 'Finance', count: 4, color: 'bg-color-state-warning-subtle text-color-state-warning-text' },
      { value: 'education', label: 'Education', count: 5, color: 'bg-brand-secondary/20 text-brand-secondary' },
      { value: 'restaurant', label: 'Restaurant/Food', count: 7, color: 'bg-color-state-error-subtle text-color-state-error-text' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'wordpress', label: 'WordPress', count: 12, color: 'bg-color-state-info-subtle text-color-state-info-text' },
      { value: 'shopify', label: 'Shopify', count: 8, color: 'bg-color-state-success-subtle text-color-state-success-text' },
      { value: 'custom-development', label: 'Custom Development', count: 15, color: 'bg-brand-tertiary/20 text-brand-tertiary' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'web-development', label: 'Web Development', count: 22, color: 'bg-color-state-info-subtle text-color-state-info-text' },
      { value: 'ux-ui-design', label: 'UX/UI Design', count: 18, color: 'bg-brand-tertiary/20 text-brand-tertiary' },
      { value: 'seo-optimization', label: 'SEO Optimization', count: 14, color: 'bg-color-state-success-subtle text-color-state-success-text' },
      { value: 'performance-optimization', label: 'Performance Optimization', count: 12, color: 'bg-color-state-warning-subtle text-color-state-warning-text' },
    ]
  },
  {
    ...
    options: [
      { value: 'conversion-optimization', label: 'Conversion Optimization', count: 16, color: 'bg-color-state-success-subtle text-color-state-success-text' },
      { value: 'sales-increase', label: 'Sales Increase', count: 12, color: 'bg-emerald-100 text-emerald-800' },
      { value: 'traffic-growth', label: 'Traffic Growth', count: 14, color: 'bg-color-state-info-subtle text-color-state-info-text' },
      { value: 'user-experience-improvement', label: 'UX Improvement', count: 18, color: 'bg-brand-tertiary/20 text-brand-tertiary' },
      { value: 'performance-enhancement', label: 'Performance Enhancement', count: 10, color: 'bg-color-state-warning-subtle text-color-state-warning-text' },
      { value: 'brand-transformation', label: 'Brand Transformation', count: 8, color: 'bg-brand-accent/20 text-pink-800' },
    ]
  }
];
