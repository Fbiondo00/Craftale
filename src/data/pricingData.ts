import { BuyerPersona, OptionalService, ServiceTier } from "@/types/pricing";
...
export const buyerPersonas: BuyerPersona[] = [
  ...
  },
  {
    ...
    characteristics: ["Età 25-40 anni", "Formazione moderna", "Orientamento digitale", "Ambizioni di crescita"],
    ...
    motivations: ["Crescita rapida", "Innovazione digitale", "Brand differenziante", "ROI misurabile"],
  ...
  },
  {
    ...
    characteristics: ["Posizionamento premium", "Clientela esigente", "Focus sulla qualità", "Budget per investimenti"],
    ...
    motivations: ["Eccellenza digitale", "Esperienze premium", "Reputation management", "Efficienza operativa"],
  ...
  },
  {
    ...
    characteristics: ["Operazioni standardizzate", "Multiple location", "Focus su efficienza", "Budget centralizzato"],
    ...
    motivations: ["Efficienza operativa", "Scalabilità sistema", "Controllo centralizzato", "Ottimizzazione costi"],
    recommendedTier: "ecommerce",
    recommendedPackage: "premium",
  },
  {
    ...
    digitalMaturity: "medium",
    painPoints: ["Comunicare unicità", "Educare il mercato", "Attrarre turisti", "Stagionalità"],
    motivations: ["Valorizzare tradizione", "Storytelling efficace", "Crescita sostenibile", "Autenticità"],
    recommendedTier: "interattiva",
    recommendedPackage: "standard",
  },
];
  ...
  },
  {
    ...
    features: [
      ...
      { id: "google-business", name: "Google Business", description: "Integrazione completa", included: true },
      {
        ...
        description: "Sistema di booking completo",
        included: true,
        highlight: true,
      },
      {
        ...
        description: "Marketing automatizzato",
        included: true,
        highlight: true,
      },
      { id: "ecommerce", name: "E-commerce", description: "Vendita online", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "ecommerce", name: "E-commerce", description: "Vendita online completa", included: true, highlight: true },
      {
        ...
        description: "Gestione ordini e consegne",
        included: true,
        highlight: true,
      },
      {
        ...
        description: "Integrazione sistemi di cassa",
        included: true,
        highlight: true,
      },
      { id: "menu-digitale", name: "Menu Digitale", description: "QR code e menu interattivo", included: true },
...
export const getPersonaRecommendation = (formData: any) => {
  ...
  const recommendedOptionals = optionalServices
    .filter(service => {
  ...
  return {
    ...
    totalEstimate: {
      ...
      monthly:
        recommendedOptionals.filter(o => o.unit === "monthly").reduce((sum, opt) => sum + opt.price, 0) || undefined,
    },
    confidence: 85,
    reasoning: [
    ...
    alternatives: serviceTiers
      ...
      .map(altTier => ({
        ...
        reason:
          altTier.packages[0].price < recommendedPackage.price ? "Opzione più economica" : "Maggiori funzionalità",
      })),
  };
};
