...
import { formatContrastResults, getContrastRatio, getWCAGLevel, testAPTYColorSystem } from "@/utils/colorContrast";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 p-6 bg-green-50 border border-green-200 rounded-lg">
          ...
          <p className="text-sm mb-2">
            All calculations on this page use the <strong>official W3C/WCAG 2.1 formulas</strong> for color contrast
            verification. These are not approximations but exact implementations of the international accessibility
            standards.
          </p>
        ...
        <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="space-y-1 text-sm">
            <li>
              • <strong>AA Normal Text:</strong> Minimum 4.5:1 contrast ratio
            </li>
            <li>
              • <strong>AA Large Text:</strong> Minimum 3:1 contrast ratio (18pt+ or 14pt+ bold)
            </li>
            <li>
              • <strong>AAA Normal Text:</strong> Minimum 7:1 contrast ratio
            </li>
            <li>
              • <strong>AAA Large Text:</strong> Minimum 4.5:1 contrast ratio
            </li>
          </ul>
        </div>
              ...
              <tbody>
                {customTests.map((test, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="border p-3 text-center font-mono">{test.ratio}:1</td>
                    <td className="border p-3 text-center">
                      <span
                        className={`px-2 py-1 rounded text-xs font-semibold ${
                          test.normalLevel === "AAA"
              ...
              Object.entries(results).map(([label, result]: [string, any]) => (
                <div
                  ...
                  className={`p-4 rounded-lg border-2 ${
                    result.normalText.AA ? "border-green-300 bg-green-50" : "border-red-300 bg-red-50"
                  }`}
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      {result.recommendation && <p className="text-sm text-red-600 mt-1">⚠️ {result.recommendation}</p>}
                    </div>
  ...
  linearized = ((channel + 0.055) / 1.055) ^ 2.4`}
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 mt-1">
                These coefficients reflect that human eyes are most sensitive to green, moderately sensitive to red, and
        ...
        <section className="mb-12">
          ...
          <div className="p-6 bg-gray-50 rounded-lg">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium mb-2">Foreground Color (RGB triplet or hex)</label>
                <input
                  type="text"
                  id="fg-input"
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Background Color (RGB triplet or hex)</label>
                <input
                  type="text"
                  id="bg-input"
        ...
        <section className="mb-12">
          ...
          <div className="p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                • <strong>Primary Purple (#6720FF):</strong> May need adjustment for better contrast on white
                backgrounds
              </li>
              <li>
                • <strong>Light grays:</strong> Ensure sufficient contrast for body text
              </li>
              <li>
                • <strong>State colors:</strong> Verify warning and info text colors meet AA standards
              </li>
            </ul>
