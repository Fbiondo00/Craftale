...
import { SignInFormData, SignUpFormData, ForgotPasswordFormData } from '@/types/auth';
          ...
          <DialogPrimitive.Portal>
            ...
            >
              ...
              <DialogPrimitive.Title className='sr-only'>
                {showEmailConfirmation ? 'Email Confirmation' : authMode === 'signin' ? 'Sign In' : authMode === 'signup' ? 'Sign Up' : 'Reset Password'}
