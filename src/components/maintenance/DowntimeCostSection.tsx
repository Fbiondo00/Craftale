      ...
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="bg-apty-bg-elevated rounded-2xl p-8 border border-apty-border-subtle">
            ...
            <div className="mt-8 p-4 bg-apty-state-error/10 rounded-lg">
              <p className="text-sm text-apty-text-primary text-center">
                <strong>La realtà delle PMI italiane:</strong> 2-3 giorni di downtime possono significare €10.000 persi
                in alta stagione, perdita definitiva di clienti e mesi per recuperare la reputazione
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonti:{" "}
            <a
              href="https://www.statista.com/statistics/1453441/italy-average-cost-incurred-by-a-data-breach/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline"
            >
              Statista Italia 2024
            </a>{" "}
            <span aria-hidden="true" className="mx-2">
              •
            </span>{" "}
            <a
              href="https://www.eib.org/attachments/thematic/digitalisation_of_smes_in_italy_summary_en.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline"
            >
