...
import { Activity, AlertTriangle, CheckCircle2, Lock, RefreshCw, Server, Shield, XCircle } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-apty-bg-base rounded-2xl p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-apty-text-primary mb-6">
                    Costi medi delle violazioni per le PMI italiane
                  </h3>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="w-full bg-apty-bg-elevated rounded-full h-3">
                        <div
                          className="h-3 bg-gradient-to-r from-apty-secondary to-apty-primary rounded-full"
                          style={{ width: "55%" }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-apty-bg-elevated rounded-full h-3">
                        <div
                          className="h-3 bg-gradient-to-r from-apty-tertiary to-apty-accent rounded-full"
                          style={{ width: "75%" }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-apty-state-error/10 rounded-lg">
                      <p className="text-sm text-apty-text-primary">
                        <strong>Impatto totale:</strong> €68.000-171.000 per violazione + 20-35% di perdita di fiducia
                        dei clienti
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="p-4 bg-apty-bg-elevated rounded-lg">
                      ...
                      <div className="text-sm text-apty-text-secondary">
                        Per violazione per le PMI (fino a €20M max)
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-apty-primary/10 rounded-lg">
                      <p className="text-xs text-apty-text-primary">
                        Le cause per privacy e downtime sono raddoppiate tra il 2022 e il 2024, le PMI rappresentano il
                        40% dei casi
                      </p>
                    </div>
                  </div>
            ...
            {activeTab === "risks" && (
              <div className="space-y-8">
                <div className="bg-apty-bg-base rounded-2xl p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-apty-text-primary mb-6">
                    Problemi web più comuni che causano interruzioni al business
                  </h3>
                  ...
                  <div className="mt-6 grid md:grid-cols-2 gap-6">
                    <div className="p-4 bg-apty-bg-elevated rounded-lg">
                      <h4 className="font-semibold text-apty-text-primary mb-3">
            ...
            {activeTab === "solutions" && (
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-apty-bg-base rounded-2xl p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-apty-text-primary mb-6">
                    Confronto dei piani di manutenzione
                  </h3>
                  <div className="space-y-4">
                    <div className="p-4 bg-apty-bg-elevated rounded-lg">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonti:{" "}
            <a
              href="https://www.clusit.it/rapporto-clusit/"
              target="_blank"
            ...
            <a
              href="https://www.agid.gov.it/it/sicurezza/cert-agid"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline"
            >
            ...
            <a
              href="https://www.polimi.it/osservatori"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline"
            >
              Politecnico Milano Cybersecurity
            </a>
          </p>
        </div>
      </div>
