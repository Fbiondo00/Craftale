      ...
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='bg-apty-bg-elevated rounded-2xl p-8 mb-8'>
            <h3 className='text-2xl font-bold text-apty-text-primary mb-8 text-center'>Reattiva vs Proattiva: confronto costi annuali</h3>
            ...
            <div className='mt-8 text-center'>
              <div className='inline-block p-6 bg-apty-primary/10 rounded-xl'>
                <div className='text-sm text-apty-text-secondary mb-2'>Risparmio annuale con manutenzione proattiva</div>
        ...
        <div className='mt-8 text-center'>
          <p className='text-sm text-apty-text-secondary'>
            Fonti:{' '}
            <a href='https://about.fb.com/news/2022/06/taking-a-deep-dive-into-the-digitisation-of-italian-smbs/' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline'>Meta Italy SMB Report</a>
            {' '}<span aria-hidden='true' className='mx-2'>•</span>{' '}
            <a href='https://www.datainsightsmarket.com/reports/website-maintenance-services-1949156' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline'>Data Insights Market 2024</a>
          </p>
        </div>
      </div>
    </section>
