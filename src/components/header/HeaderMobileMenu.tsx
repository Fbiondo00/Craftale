                ...
                <div className="min-h-full flex flex-col">
                  ...
                  <div className="flex-1 container mx-auto px-6 py-8">
                    <nav className="flex flex-col">
                      ...
                      {[...navigationItems, { title: "Contact Us", href: "/contact" }].map((item, index) => (
                        <motion.div
                          key={item.title}
                        ...
                        >
                          {(item as any).comingSoon ? (
                            // Coming soon item
                            <div className="group flex items-center justify-between py-4 text-lg font-medium text-apty-text-secondary border-b border-apty-border-subtle cursor-pointer active:bg-apty-bg-muted">
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <div>
                                            ...
                                            <div className="text-xs text-apty-text-tertiary">{subItem.description}</div>
                                          </div>
                                        </motion.a>
                                      );
                                    })}
