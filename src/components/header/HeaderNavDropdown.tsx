...
export function HeaderNavDropdown({ title, description, items, children }: HeaderNavDropdownProps) {
            ...
            <div className="grid gap-3 lg:grid-cols-2">
              ...
              <div className="row-span-3">
                <div className="flex h-full flex-col justify-between rounded-apty-lg bg-gradient-to-b from-apty-bg-muted/50 to-apty-bg-subtle p-6 no-underline outline-none apty-transition focus:shadow-apty-md">
                  ...
                  <p className="text-sm leading-tight text-apty-text-secondary">{description}</p>
                  <AptyDropdownCTA className="mt-4 w-fit">Explore {title}</AptyDropdownCTA>
                </div>
              </div>
