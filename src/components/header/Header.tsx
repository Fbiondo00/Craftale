...
import { Code2, Monitor, Search, Sparkles, Users } from "lucide-react";
      ...
      <HeaderScrollEffects>
        <div className="container mx-auto px-4">
          <nav className="flex items-center justify-between h-16 md:h-20">
            ...
            <a href="/" className="flex items-center space-x-3 group hover:scale-[1.02] apty-transition">
              <div className="relative">
                <img src="/logo.png" alt="Craftale Logo" className="w-10 h-10 md:w-12 md:h-12" />
              </div>
            ...
            <div className="hidden lg:flex items-center space-x-2">
              <HeaderAuthActions sessionUser={sessionUser} onOpenAuthModal={onOpenAuthModal} onSignOut={onSignOut} />
            </div>
