      ...
      <>
        {isAuthenticated ? (
          ...
          <div className="space-y-2">
            ...
            {/* Menu actions */}
            <Button variant="ghost" className="w-full justify-start" onClick={onMobileMenuClose}>
              <LayoutDashboard className="mr-2 h-4 w-4" />
              Dashboard
            </Button>
            <Button variant="ghost" className="w-full justify-start" onClick={onMobileMenuClose} asChild>
              <a href="/profile">
    ...
    <div className="flex items-center">
      ...
      {isAuthenticated ? (
        ...
        <div className="flex items-center space-x-2">
          <AptySecondaryButton onClick={() => onOpenAuthModal?.("signin")} size="md">
            Accedi
          </AptySecondaryButton>
          <AptyPrimaryButton onClick={() => onOpenAuthModal?.("signin")} size="md" withChevron>
            Inizia Ora
          </AptyPrimaryButton>
        </div>
      )}
