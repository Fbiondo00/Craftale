...
const variantStyles = {
  default: {
    container: 'hover:bg-gradient-to-r hover:from-brand-tertiary/10 hover:to-violet-50 dark:hover:from-purple-950/50 dark:hover:to-violet-950/50',
  ...
  danger: {
    container: 'hover:bg-gradient-to-r hover:from-red-50 hover:to-brand-accent/10 dark:hover:from-red-950/50 dark:hover:to-pink-950/50',
  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        <ChevronDown 
          className={cn(
            'w-4 h-4 text-muted-foreground -rotate-90 transition-colors duration-200',
            styles.chevron
          )}
        />
      </button>
