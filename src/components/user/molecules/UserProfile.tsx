...
export const UserProfile = React.forwardRef<HTMLDivElement, UserProfileProps>(({ user, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-base font-semibold text-foreground truncate">{user.fullName}</div>
