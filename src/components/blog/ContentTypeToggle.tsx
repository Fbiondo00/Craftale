...
import { type ContentType, type ContentTypeToggleProps } from "@/types/blog";
...
export default function ContentTypeToggle({ contentTypes, selectedTypes, onToggle, configs }: ContentTypeToggleProps) {
    ...
    <div className="flex flex-wrap gap-3 items-center">
      ...
      >
        <span className="flex items-center gap-2">
          ...
          {isAllSelected && <span className="w-2 h-2 bg-white rounded-full" />}
        </span>
      </motion.button>
