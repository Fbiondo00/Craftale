    ...
    features: [
      ...
      },
      {
        ...
        tier1: {
          ...
          longDescription: "Menu tradizionale in formato digitale con design professionale e categorizzazione base",
        },
        tier2: {
          value: "Avanzato",
          shortDescription: "Filtri allergie e preferenze",
          longDescription: "Menu interattivo con filtri per allergie, preferenze dietetiche e disponibilità real-time",
        },
        tier3: {
          value: "Intelligence",
      ...
      },
      {
        ...
        tier3: {
          ...
          longDescription: "Content hub completo con blog, ricette, video, podcast integration e calendario editoriale",
        },
      },
    ],
  },
    ...
    features: [
      ...
      },
      {
        ...
        tier2: {
          ...
          longDescription: "Sistema punti base con QR codes, gestione clienti fedeli e rewards per visite frequenti",
        },
        tier3: {
          value: "Avanzato",
    ...
    features: [
      ...
      },
      {
        ...
        tier1: {
          ...
          longDescription: "Ottimizzazione base della velocità con compressione immagini e Core Web Vitals conformi",
        },
        tier2: {
          value: "Avanzata",
        ...
        tier3: {
          ...
          longDescription: "App mobile nativa iOS/Android con notifiche push avanzate e performance enterprise-grade",
        },
      },
      {
    ...
    features: [
      ...
      },
      {
        ...
        tier1: {
          ...
          longDescription: "Integrazione base con link social media, widget Instagram e connessioni social automatiche",
        },
        tier2: {
          value: "Automatica",
    ...
    features: [
      ...
      },
      {
        ...
        tier2: {
          ...
          longDescription: "Payment gateway integrato per depositi prenotazioni con Nexi, PayPal e carte principali",
        },
        tier3: {
          value: "Completo",
    ...
    features: [
      ...
      },
      {
        ...
        tier1: {
          ...
          longDescription: "Monitoraggio uptime base con controlli giornalieri e notifiche per downtime prolungati",
        },
        tier2: {
          value: "24/7",
