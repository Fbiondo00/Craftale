...
import { ArrowRight, Building, Check, Crown, Star, X, Zap } from "lucide-react";
...
export default function TierCards() {
  ...
  return (
    <>
      ...
      <div className="mb-16">
        <h3 className="text-3xl font-bold text-center mb-2">TIER 1: Presenza Digitale Essenziale</h3>
      ...
      <div className="mb-16">
        <h3 className="text-3xl font-bold text-center mb-2">TIER 2: Esperienza Interattiva Moderna</h3>
        <p className="text-color-tertiary text-center mb-8">
          ...
          >
            <div className="relative p-6 bg-gradient-to-r from-brand-secondary via-brand-tertiary to-brand-accent">
              ...
              <div className="text-white">
                ...
                <div className="text-4xl font-bold mb-2">€{selectedTierData.price.toLocaleString("it-IT")}</div>
