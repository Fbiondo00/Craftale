...
// Import types
import type { CompletionType, QuoteRequest } from "@/types/step4-quote-request";
...
const Step4QuoteSuccess: React.FC<Step4QuoteSuccessProps> = ({ quoteRequest, onBackToHome, onNewQuote, className }) => {
  ...
  const getExpectedResponseTime = (completionType: CompletionType): string => {
    return completionType === "complete_journey" ? "entro 4 ore lavorative" : "entro 24 ore lavorative";
  };
  ...
  return (
    ...
    >
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="text-color-state-info-text space-y-2">
              ...
              <p>
                • Il nostro team ti contatterà al numero {formatPhoneNumber(quoteRequest.userData?.phone || "")}
      ...
      {/* Footer Note */}
      <motion.div variants={itemVariants} className="text-center mt-12 pt-8 border-t border-color-default">
        <p className="text-color-muted">
          Hai domande? Contattaci a{" "}
          <a href="mailto:info@webagency.it" className="text-brand-secondary hover:text-brand-secondary font-medium">
            info@webagency.it
          </a>{" "}
          o al{" "}
