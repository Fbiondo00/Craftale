...
import { PricingState, PersonaMatcherForm, } from '@/types/pricing'; //removed  RecommendationResult
import { getPersonaRecommendation } from '@/data/pricingData'; // removed serviceTiers, 
      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-color-tertiary max-w-3xl mx-auto mb-8'>
            Dalle trattorie familiari ai ristoranti upscale, abbiamo la soluzione perfetta per far
            crescere la tua attività online. Scopri quale pacchetto fa per te.
          </p>
              ...
              <div className='bg-gradient-to-r from-brand-secondary via-brand-tertiary to-brand-accent rounded-2xl p-8 text-white'>
                <div className='max-w-2xl mx-auto'>
                  ...
                  <p className='text-white/90 mb-6'>
                    Rispondi a 5 semplici domande e ti consiglieremo la soluzione perfetta per il
                    tuo tipo di ristorante e i tuoi obiettivi.
                  </p>
                  <button
                    onClick={openPersonaMatcher}
          ...
          <div className='grid md:grid-cols-2 gap-6 max-w-4xl mx-auto'>
            <div className='bg-white rounded-xl p-6 shadow-sm border border-color-subtle text-left'>
              <h4 className='font-semibold text-color-primary mb-2'>
                Quanto tempo serve per il mio sito?
              </h4>
              <p className='text-color-tertiary text-sm'>
                I tempi variano da 2-3 settimane per soluzioni essenziali a 4-6 settimane per
                piattaforme e-commerce complete.
              </p>
            </div>
            <div className='bg-white rounded-xl p-6 shadow-sm border border-color-subtle text-left'>
              <h4 className='font-semibold text-color-primary mb-2'>
                Posso aggiungere funzionalità dopo?
              </h4>
              <p className='text-color-tertiary text-sm'>
