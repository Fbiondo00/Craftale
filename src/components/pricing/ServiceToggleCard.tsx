      ...
      <div className="relative h-full rounded-xl overflow-hidden">
        ...
        <motion.div
          className={cn(
            ...
            isSelected &&
              "border-brand-secondary/50 shadow-md bg-gradient-to-br from-brand-secondary/20 to-brand-tertiary/20 dark:from-brand-secondary/40 dark:to-brand-tertiary/40",
          )}
        >
          {/* Gradient overlay when selected */}
          {isSelected && (
            <motion.div
              className="absolute inset-0 rounded-lg opacity-30 bg-gradient-to-br from-brand-secondary/20 to-brand-tertiary/20"
              style={{
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isSelected ? "bg-gradient-to-r from-brand-secondary to-brand-tertiary" : "bg-gray-400",
                          )}
                        />
