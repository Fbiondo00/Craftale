    ...
    <>
      ...
      {onPersonaMatcherOpen && (
        ...
        >
          ...
          <motion.button
            className="relative w-full rounded-xl p-6 bg-apty-bg-elevated/90 backdrop-blur-sm border border-color-default shadow-xl text-left transition-all duration-300 hover:shadow-2xl group"
      ...
      <motion.div
        ...
        className="bg-apty-bg-elevated rounded-xl border-2 border-brand-secondary/30 p-6 shadow-lg"
      >
