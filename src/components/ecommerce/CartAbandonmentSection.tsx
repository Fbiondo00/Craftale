      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonti:
            <a
              href="https://pacvue.com/blog/eu-commerce-deep-dive-series-italy-trends-insights/"
              target="_blank"
            ...
            ,
            <a
              href="https://www.mordorintelligence.com/industry-reports/italy-ecommerce-market"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
