...
import { AlertCircle, CheckCircle2, CreditCard, Euro, ShoppingCart, TrendingUp, Users } from "lucide-react";
      ...
      <div className="container mx-auto px-0 md:px-4 max-w-7xl">
        ...
        <div className="w-full">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-1 sm:p-4 md:p-8 lg:p-12">
              ...
              <div className="grid grid-cols-4 gap-0.5 sm:gap-2 md:gap-4 text-white">
                ...
                >
                  ...
                  <p className="text-[9px] sm:text-xs md:text-sm font-medium text-white/70 uppercase tracking-tighter sm:tracking-wider">
                    Visitatori
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-[9px] sm:text-xs md:text-sm font-medium text-white/70 uppercase tracking-titter sm:tracking-wider">
                    Acquisto
                  </p>
                </motion.div>
              </div>
            ...
            <div className="hidden sm:block absolute bottom-4 right-4 text-white/30 text-xs">craftale.it</div>
          </motion.div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs md:text-sm text-apty-text-secondary">
            Fonti:
            <a
              href="https://ecommercedb.com/benchmarks/it/all"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
              E-commerce DB Italia
            </a>
            ,
            <a
              href="https://www.hotjar.com/conversion-rate-optimization/funnel-analysis/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
