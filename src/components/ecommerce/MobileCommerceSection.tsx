...
import { CheckCircle2, Clock, Package, Smartphone, Zap } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonte:
            <a
              href="https://www.statista.com/topics/6924/mobile-commerce-in-italy/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
              Statista Mobile Commerce Italia
            </a>
          </p>
        </div>
      </div>
