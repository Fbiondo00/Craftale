...
import { CheckCircle2, CreditCard, RefreshCw, Shield } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-apty-bg-base rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-apty-text-primary mb-6">
              Costruire Fiducia con gli Acquirenti Italiani
            </h3>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonti:
            <a
              href="https://www.statista.com/statistics/1372511/implementation-plans-of-digital-payment-types-italy/"
              target="_blank"
            ...
            ,
            <a
              href="https://stripe.com/resources/more/italian-ecommerce-payments"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
