      ...
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <div className='mt-8 text-center'>
          <p className='text-sm text-apty-text-secondary'>
            Fonti: 
            <a href='https://ecommercenews.eu/ecommerce-in-europe/ecommerce-italy/' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline mx-1'>E-commerce News EU</a>,
            <a href='https://www.casaleggio.it/e-commerce/' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline mx-1'>Casaleggio Associati</a>
          </p>
        </div>
      </div>
    </section>
