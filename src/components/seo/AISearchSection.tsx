...
import { Bot, TrendingDown, Target, Brain } from 'lucide-react';
    ...
    <section className='py-24 md:py-32 bg-apty-bg-subtle'>
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid md:grid-cols-3 gap-6 mb-12'>
            ...
            >
              ...
              <p className='text-sm text-apty-text-secondary'>
                Aumento visite da ChatGPT, Gemini e altri AI assistant
              </p>
            </motion.div>
          ...
          <div className='bg-apty-bg-base rounded-2xl p-8 border border-apty-border-subtle'>
            <h3 className='text-2xl font-bold text-apty-text-primary mb-8 text-center'>Opportunità e Sfide per PMI Italiane</h3>
                ...
                <ul className='space-y-3'>
                  <li className='flex items-start gap-2'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-apty-text-secondary'>usa AI per SEO = vantaggio competitivo per early adopter</p>
                    </div>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='text-apty-primary mt-1'>•</span>
                  ...
                  <li className='flex items-start gap-2'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-apty-text-secondary'>Schema markup diventa cruciale per AI understanding</p>
                    </div>
                  </li>
                </ul>
              </div>
                ...
                <ul className='space-y-3'>
                  ...
                  <li className='flex items-start gap-2'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-apty-text-secondary'>Meno spazio per risultati organici tradizionali</p>
                    </div>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='text-apty-state-error mt-1'>•</span>
            ...
            <div className='mt-8 p-4 bg-apty-secondary/10 rounded-lg'>
              <p className='text-sm text-apty-text-primary text-center'>
                <strong>Strategia vincente:</strong> Contenuti unici e approfonditi • E-E-A-T forte • Ottimizzazione per featured snippets • Schema markup completo
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='mt-8 text-center'>
          <p className='text-sm text-apty-text-secondary'>
            Fonti: 
            <a href='https://www.nic.it/en/news/2025/registry-wmf-2025-glimpse-future-web-age-ai' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline mx-1'>Registro .it WMF 2025</a>,
            <a href='https://www.advancedwebranking.com/blog/ai-impact-on-international-seo' target='_blank' rel='noopener noreferrer' className='text-apty-primary hover:underline mx-1'>Advanced Web Ranking</a>
          </p>
        </div>
      </div>
    </section>
