      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          >
            ...
            <span className='text-sm font-medium text-apty-text-inverse'>93-96% dei clic vanno alla prima pagina Google</span>
          </motion.div>
          ...
          <p className='text-xl md:text-2xl text-apty-text-inverse/80 mb-8 max-w-3xl mx-auto leading-relaxed'>
            <span className='font-semibold text-apty-text-inverse'>71% delle ricerche in Italia</span> avviene da mobile.
            Le PMI senza SEO perdono <span className='font-semibold text-apty-text-inverse'>34-40% di quota di mercato</span> in 18 mesi.
            ROI medio SEO: <span className='font-semibold text-apty-text-inverse'>500-900%</span>.
          </p>
