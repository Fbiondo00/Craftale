...
import { Monitor, MousePointer, Smartphone } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="bg-apty-bg-elevated rounded-2xl p-8 border border-apty-border-subtle">
            ...
            <div className="relative pl-8 md:pl-12">
              ...
              <div className="relative flex items-end justify-between gap-2 md:gap-4 lg:gap-8 h-64 ml-2 md:ml-4">
                {ctrData.map((item, index) => {
                  ...
                  return (
                    <div key={item.position} className="flex-1 flex flex-col items-center justify-end">
                      {/* Value Label */}
                      <div className="text-sm md:text-lg font-bold text-apty-text-primary mb-2">{item.value}%</div>
            ...
            <div className="mt-6 p-4 bg-apty-primary/5 rounded-lg border border-apty-primary/20">
              <p className="text-sm text-apty-text-primary">
                <strong>Insight chiave:</strong> La posizione 1 genera 2.5x più clic della posizione 2 e 4.2x più della
                posizione 3. Il 96% di tutti i clic avviene nella prima pagina dei risultati.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-apty-text-secondary">
            Fonti:
            <a
              href="https://www.ictprosdo.com/tag/crescita-digitale-pmi/"
              target="_blank"
            ...
            ,
            <a
              href="https://www.consorzionetcomm.it"
              target="_blank"
              rel="noopener noreferrer"
              className="text-apty-primary hover:underline mx-1"
            >
