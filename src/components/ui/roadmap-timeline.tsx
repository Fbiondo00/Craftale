...
import { CheckCircle, Circle, Clock, ArrowRight, Target, Palette, Code2, TrendingUp, Rocket, Lightbulb } from 'lucide-react';
...
const RoadmapTimeline: React.FC<RoadmapTimelineProps> = ({ 
  ...
  return (
    <section className={`relative bg-gradient-to-br from-brand-secondary/10/50 via-brand-tertiary/10/30 to-brand-accent/10/50 overflow-hidden ${className}`} ref={containerRef}>
      <GeometricPattern 
        width={80}
        height={80}
