    ...
    <section className="py-24 bg-apty-bg-subtle">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <p className="text-lg text-apty-text-secondary mb-12 leading-relaxed max-w-3xl mx-auto">
          Siamo pronti a scriverla insieme. Trasformiamo la tua visione in un racconto digitale che converte, coinvolge
          e fa crescere il tuo business. Consulenza gratuita inclusa.
        </p>
        {/* Trust Indicators */}
