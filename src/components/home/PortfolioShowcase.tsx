...
import { ArrowRight, Monitor, ExternalLink } from 'lucide-react';
      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Don't just take our word for it. See how we&apos;ve helped businesses like yours increase
            sales, generate leads, and grow their online presence.
          </p>
        </motion.div>
