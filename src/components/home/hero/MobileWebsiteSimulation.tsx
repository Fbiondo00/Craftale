...
import { Menu, Search, ShoppingBag, Heart, User, Star, ArrowRight } from 'lucide-react';
    ...
    >
      ...
      <div className='relative w-[375px] h-[700px] bg-apty-bg-base rounded-[40px] overflow-hidden shadow-apty-brand-lg border-2 border-apty-border-default'>
        ...
        <div ref={containerRef} className='relative px-5 pb-20 h-[260px] overflow-hidden'>
          ...
          >
            {[
              { name: 'Minimal Tee', price: '$42', rating: 4.5, image: 'bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800' },
              { name: 'Denim Jacket', price: '$89', rating: 4.8, image: 'bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800' },
              { name: 'Classic Sneakers', price: '$79', rating: 4.6, image: 'bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900 dark:to-purple-800' },
              { name: 'Leather Bag', price: '$149', rating: 4.9, image: 'bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-900 dark:to-amber-800' },
            ].map((product, i) => (
              <motion.div
                key={i}
                    ...
                    >
                      <Heart 
                        className={`w-4 h-4 apty-transition ${
                          likedItems.has(i) 
                            ? 'text-apty-accent fill-apty-accent' 
        ...
        <div className='absolute bottom-0 left-0 right-0 bg-apty-bg-base border-t border-apty-border-subtle'>
          <div className='flex items-center justify-around py-3'>
            {[
              ...
              <button
                key={item.label}
                className='flex flex-col items-center gap-1 hover:opacity-80 apty-transition'
              >
                ...
                <span className={`text-[10px] ${item.active ? 'text-apty-primary font-medium' : 'text-apty-text-tertiary'}`}>
                  {item.label}
                </span>
              </button>
            ))}
