              ...
              ">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className={`
                    ...
                    flex-shrink-0
                    ${
                      index === 0 ? 'bg-gradient-to-br from-cyan-400 to-cyan-500' : 
                      index === 1 ? 'bg-gradient-to-br from-orange-300 via-orange-400 to-yellow-400' : 
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-apty-text-secondary mt-0.5">
                      {project.category}
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm text-apty-text-secondary mb-6 flex-grow leading-relaxed">
                  {project.description}
                </p>
