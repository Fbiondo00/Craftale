...
export const EmailConfirmation: React.FC<EmailConfirmationProps> = ({ email, onResendEmail, onBackToSignIn }) => {
        ...
        <CardContent className="space-y-6">
          <div className="bg-apty-bg-subtle border border-apty-border-subtle rounded-lg p-4">
            ...
            <p className="text-sm text-apty-text-secondary">
              Controlla la tua email e clicca sul link di conferma per attivare il tuo account. Il link scade tra 24
              ore.
            </p>
          </div>
