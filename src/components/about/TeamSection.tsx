      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-apty-text-secondary max-w-3xl mx-auto px-2 sm:px-4 md:px-0">
            Tre professionisti con background diversi ma una visione comune: creare esperienze digitali che fanno la
            differenza. Competenze tecniche, sensibilità creativa e passione per l'innovazione guidano ogni nostro
            progetto.
          </p>
        </motion.div>
            ...
            >
              <div className="bg-apty-bg-muted rounded-xl overflow-hidden group">
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold text-apty-text-primary mb-1">{founder.name}</h3>
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <p className="text-sm sm:text-base text-apty-primary font-medium">{founder.role}</p>
